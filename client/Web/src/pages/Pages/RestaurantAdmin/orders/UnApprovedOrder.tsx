...
const UnApprovedOrder = () => {
    ...
    // Helper to format order number like #O001
    ...
    return (
        <div>
            <div className="panel mt-6">
                <h5 className="font-semibold text-lg dark:text-white-light mb-5">Orders</h5>
                        ...
                        columns={[
                            {
                                ...
                                render: ({ _id }, index) => (
                                    <div className="flex items-center gap-4">
                                        <span className="font-semibold">{formatOrderId((page - 1) * pageSize + index)}</span>
                                    </div>
                                ),
                            },
                            {
                                        ...
                                        <select
                                            ...
                                            onChange={async (e) => {
                                                ...
                                                try {
                                                    ...
                                                    setRecordsData((prev) => prev.map((order) => (order._id === _id ? { ...order, status: newStatus } : order)));
                                                } catch (error) {
