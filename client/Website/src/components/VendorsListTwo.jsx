...
import { getRestaurantById } from "../services/users/users";
...
const VendorsListTwo = () => {
  ...
  useEffect(() => {
    const fetchRestaurantDetails = async () => {
      try {
        // const response = await api.get(`/users/api/v1/users/restaurants/${id}`);
            ...
            <div className={`shop-sidebar ${active && "active"}`}>
              ...
              {restaurant ? (
                  <div className="vendor-card style-two text-center px-16 pb-24 bg-main-50">
                    {/* Restaurant Logo */}
                    <img
                      src={restaurant.logo || "assets/images/thumbs/default-logo.png"}
                      alt={restaurant.restaurantName}
                      className="vendor-card__logo m-12"
                    />

                    {/* Restaurant Name */}
                    <h6 className="title mt-32">{restaurant.restaurantName}</h6>
                    ...
                    {/* Phone Number */}
                    <p className="text-neutral-600 my-12">📞 {restaurant.restaurantPhone}</p>

                    {/* Description */}
                    <p className="text-neutral-600 my-24">
                      Experience the best pizza in {restaurant.restaurantAddress.city}. Fresh ingredients, great taste!
                    </p>
                  ...
                  <p className="text-center text-neutral-600">Loading restaurant details...</p>
                )}
